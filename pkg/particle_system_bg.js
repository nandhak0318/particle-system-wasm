...
export class Particle {
    ...
    * @returns {Particle}
    */
    static new(x, y, vx, vy, color) {
        const ptr0 = passStringToWasm0(color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.particle_new(x, y, vx, vy, ptr0, len0);
        return Particle.__wrap(ret);
    }
    /**
    */
    update() {
        wasm.particle_update(this.__wbg_ptr);
    }
    /**
    * @returns {any}
    */
    to_js_value() {
        const ret = wasm.particle_to_js_value(this.__wbg_ptr);
...
export class ParticleSystem {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ParticleSystem.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    static new() {
        const ret = wasm.particlesystem_new();
        return ParticleSystem.__wrap(ret);
    }
    /**
    ...
    */
    add_particle(particle) {
        ...
        wasm.particlesystem_add_particle(this.__wbg_ptr, ptr0);
    }
    /**
    */
    update() {
        wasm.particlesystem_update(this.__wbg_ptr);
    }
    /**
    * @returns {Array<any>}
    */
